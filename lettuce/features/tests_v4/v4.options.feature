...
@v4 @options @subnet
    ...
    Test Setup:
    Server is configured with 192.0.2.0/24 subnet with 192.0.2.1-192.0.2.10 pool.
    Server is configured with ip-forwarding option with value false.
    Server is started. 
    ...
    Response option 19 MUST contain value false.
...
@v4 @options @subnet
    ...
    Test Setup:
    Server is configured with 192.0.2.0/24 subnet with 192.0.2.1-192.0.2.10 pool.
    Server is configured with non-local-source-routing option with value false.
    Server is started. 
    ...
    Response option 20 MUST contain value false.
