...
def test_v4_host_reservation_mysql_one_address_inside_pool(step):
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v4_host_reservation_mysql_one_address_inside_pool_option(step):
    misc.test_setup(step)
    # outside of the pool
    # TODO update names
    srv_control.config_srv_subnet(step, '192.168.50.0/24', '192.168.50.1-192.168.50.50')
    srv_control.enable_db_backend_reservation(step, 'MySQL')
    srv_control.new_db_backend_reservation(step, 'MySQL', 'hw-address', 'ff:01:02:03:ff:04')
    srv_control.update_db_backend_reservation(step, 'next_server', '11.1.1.1', 'MySQL', '1')
    srv_control.update_db_backend_reservation(step,
                                              'server_hostname',
                                              'hostname-server.com',
                                              'MySQL',
                                              '1')
    srv_control.update_db_backend_reservation(step, 'boot_file_name', 'file-name', 'MySQL', '1')
    srv_control.update_db_backend_reservation(step, 'ipv4_address', '192.168.50.10', 'MySQL', '1')
    srv_control.update_db_backend_reservation(step, 'dhcp4_subnet_id', '1', 'MySQL', '1')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v4_host_reservation_mysql_one_address_outside_pool_dual_backend(step):
    misc.test_setup(step)
    # outside of the pool
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v4_host_reservation_mysql_one_address_inside_pool_different_mac(step):
    misc.test_setup(step)
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v4_host_reservation_mysql_multiple_address_reservation_empty_pool(step):
    misc.test_setup(step)
    # request address from different mac that has been reserved
    srv_control.config_srv_subnet(step, '192.168.50.0/24', '192.168.50.10-192.168.50.10')
    srv_control.enable_db_backend_reservation(step, 'MySQL')
    ...
    srv_control.new_db_backend_reservation(step, 'MySQL', 'hw-address', 'ff:01:02:03:ff:03')
    srv_control.update_db_backend_reservation(step, 'hostname', 'reserved-hostname', 'MySQL', '2')
    srv_control.update_db_backend_reservation(step, 'ipv4_address', '192.168.50.11', 'MySQL', '2')
    srv_control.update_db_backend_reservation(step, 'dhcp4_subnet_id', '1', 'MySQL', '2')
    srv_control.upload_db_reservation(step, 'MySQL')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v4_host_reservation_multiple_mysql_address_reservation_empty_pool_2(step):
    misc.test_setup(step)
    # request address from different mac that has been reserved
    ...
    srv_control.new_db_backend_reservation(step, 'MySQL', 'hw-address', 'ff:01:02:03:ff:02')
    srv_control.update_db_backend_reservation(step, 'hostname', 'reserved-hostname', 'MySQL', '3')
    srv_control.update_db_backend_reservation(step, 'ipv4_address', '192.168.50.12', 'MySQL', '3')
    srv_control.update_db_backend_reservation(step, 'dhcp4_subnet_id', '1', 'MySQL', '3')
