...
@v4 @kea_only @controlchannel @hook @network_cmds
  ...
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-list","arguments":{}}
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command": "network4-del","arguments":{"name":"name-xyz"}}
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-list","arguments":{}}
...
@v4 @kea_only @controlchannel @hook @network_cmds
  ...
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-list","arguments":{}}
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-del","arguments":{"name":"name-xyzcs"}}
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-list","arguments":{}}
...
@v4 @kea_only @controlchannel @hook @network_cmds
  ...
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command": "network4-del","arguments":{"name":"name-abc"}}
...
@v4 @kea_only @controlchannel @hook @network_cmds @disabled
  ...
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command":"network4-add","arguments":{"subnet4":[{"subnet":"192.168.50.0/24","interface":"eth2","id":66,"pools":[{"pool":"192.168.50.1-192.168.50.1"}]}]}}
  ...
  Using UNIX socket on server in path $(SOFTWARE_INSTALL_DIR)var/kea/control_socket send {"command": "network4-del","arguments":{"id":66}}
