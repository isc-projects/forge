...
def test_ddns4_notsig_forw_and_rev_release():
    ...
    srv_control.add_forward_ddns('four.example.com.', 'EMPTY_KEY', '192.168.50.252', '53')
    srv_control.add_reverse_ddns('50.168.192.in-addr.arpa.', 'EMPTY_KEY', '192.168.50.252', '53')
...
def test_ddns4_notsig_rev_release():
