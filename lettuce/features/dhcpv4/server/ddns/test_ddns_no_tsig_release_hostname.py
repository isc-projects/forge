...
def test_ddns4_notsig_forw_and_rev_release_hostname(step):
...
@pytest.mark.notsig
@pytest.mark.forward_reverse_remove
def test_ddns4_notsig_forw_and_rev_release_notenabled_hostname(step):
...
def test_ddns4_notsig_rev_release_hostname(step):
...
@pytest.mark.notsig
@pytest.mark.expire
def test_ddns4_notsig_expire_hostname(step):
