...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_chaddr(step):
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_chaddr_multiple_pools(step):

    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '192.168.50.0/24', '192.168.50.1-192.168.50.1')
    srv_control.new_pool(step, '192.168.50.2-192.168.50.2', '0')
    srv_control.new_pool(step, '192.168.50.3-192.168.50.3', '0')
    srv_control.build_and_send_config_files(step, 'SSH', 'config-file')
    srv_control.start_srv(step, 'DHCP', 'started')

    misc.test_procedure(step)
    srv_msg.client_requests_option(step, '1')
    srv_msg.client_sets_value(step, 'Client', 'chaddr', '00:00:00:00:00:01')
    srv_msg.client_send_msg(step, 'DISCOVER')
    ...
    misc.test_procedure(step)
    srv_msg.client_requests_option(step, '1')
    srv_msg.client_sets_value(step, 'Client', 'chaddr', '00:00:00:00:00:02')
    srv_msg.client_send_msg(step, 'DISCOVER')
    ...
    misc.test_procedure(step)
    srv_msg.client_requests_option(step, '1')
    srv_msg.client_sets_value(step, 'Client', 'chaddr', '00:00:00:00:00:03')
    srv_msg.client_send_msg(step, 'DISCOVER')

    misc.pass_criteria(step)
    srv_msg.send_wait_for_message(step, 'MUST', None, 'OFFER')
    srv_msg.response_check_include_option(step, 'Response', None, '1')
    srv_msg.response_check_content(step, 'Response', None, 'yiaddr', '192.168.50.3')
    srv_msg.response_check_option_content(step, 'Response', '1', None, 'value', '255.255.255.0')

    misc.test_procedure(step)
    srv_msg.client_sets_value(step, 'Client', 'chaddr', '00:00:00:00:00:03')
    srv_msg.client_copy_option(step, 'server_id')
    srv_msg.client_does_include_with_value(step, 'requested_addr', '192.168.50.3')
    srv_msg.client_requests_option(step, '1')
    srv_msg.client_send_msg(step, 'REQUEST')
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_chaddr_empty_pool(step):
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_client_id(step):
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_client_id_empty_pool(step):
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_client_id_chaddr_empty_pool(step):
...
@pytest.mark.dhcp4
@pytest.mark.request
def test_v4_request_selecting_success_second_request_fail(step):
