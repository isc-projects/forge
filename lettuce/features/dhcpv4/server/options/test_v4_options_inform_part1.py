...
def test_v4_options_inform_subnet_mask(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_time_offset(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_routers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_time_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_name_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_domain_name_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_log_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_cookie_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_lpr_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_impress_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_resource_location_servers(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_host_name(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_boot_size(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_merit_dump(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_swap_server(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_root_path(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_extensions_path(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_policy_filter(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_max_dgram_reassembly(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_default_ip_ttl(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_path_mtu_aging_timeout(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_invalid(step):
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_relay(step):
    ...
    srv_msg.client_sets_value(step, 'Client', 'broadcastBit', '1')
...
@pytest.mark.subnet
@pytest.mark.dhcp_inform
def test_v4_options_inform_invalid_with_serverid(step):
