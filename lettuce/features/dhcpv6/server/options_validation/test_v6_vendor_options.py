...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_tftp_servers(step):
    ...
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'tftp-servers', '2001:558::76')
...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_config_file(step):
    #  Testing server ability to configure it with vendor-specific options
    #  and share it with user.
...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_syslog_servers(step):
    #  Testing server ability to configure it with vendor-specific options
    #  and share it with user.
    ...
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/32', '3000::1-3000::2')
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'syslog-servers', '2001::101')
    srv_control.build_and_send_config_files(step, 'SSH', 'config-file')
    srv_control.start_srv(step, 'DHCP', 'started')
...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_time_servers(step):
    #  Testing server ability to configure it with vendor-specific options
    #  and share it with user.
    ...
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/32', '3000::1-3000::2')
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'time-servers', '2001::76')
    srv_control.build_and_send_config_files(step, 'SSH', 'config-file')
    srv_control.start_srv(step, 'DHCP', 'started')
...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_time_offset(step):
    #  Testing server ability to configure it with vendor-specific options
    #  and share it with user.
    ...
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/32', '3000::1-3000::2')
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'time-offset', '-18000')
    srv_control.build_and_send_config_files(step, 'SSH', 'config-file')
    srv_control.start_srv(step, 'DHCP', 'started')
...
@pytest.mark.options
@pytest.mark.vendor
def test_v6_options_vendor_multiple(step):
    #  Testing server ability to configure it with vendor-specific options
    #  and share it with user.
    #  In this case: for vendor id vendor-4491 set option time-offset with value -18000
