...
@pytest.mark.release
def test_v6_statuscode_nobinding_release_noleases(step):
    ...
    srv_msg.response_check_option_content(step, 'Response', '13', None, 'statuscode', '3')
...
def test_v6_statuscode_nobinding_release(step):
    #  Testing server ability server ability perform RELEASE - REPLY message exchange.
    #  Message details 		Client		Server
    #  						SOLICIT -->
    #  		   						<--	ADVERTISE
...
@pytest.mark.release
@pytest.mark.disabled
def test_v6_statuscode_nobinding_release_new_client_id(step):
    #  Testing server ability server ability perform RELEASE - REPLY message exchange.
    ...
    misc.test_procedure(step)
    srv_msg.generate_new(step, 'Client_ID')
    srv_msg.client_add_saved_option(step, None)
    srv_msg.client_does_include(step, 'Client', None, 'client-id')
    srv_msg.client_send_msg(step, 'RELEASE')
...
@pytest.mark.status_code
@pytest.mark.release
def test_v6_statuscode_nobinding_release_advertise(step):
    #  Testing server ability server ability perform RELEASE - REPLY message exchange.
...
@pytest.mark.release
@pytest.mark.disabled
def test_v6_statuscode_nobinding_release_nobinding(step):
    #  Testing server ability server ability perform RELEASE - REPLY message exchange.
    #  Message details 		Client		Server
    #  						SOLICIT -->
    #  		   						<--	ADVERTISE
...
@pytest.mark.status_code
@pytest.mark.release
def test_v6_statuscode_success_release(step):
    #  Testing server ability server ability perform RELEASE - REPLY message exchange.
    #  Message details 		Client		Server
    #  						SOLICIT -->
    #  		   						<--	ADVERTISE
    ...
    srv_msg.response_check_include_option(step, 'Response', None, '2')
    srv_msg.response_check_include_option(step, 'Response', None, '3')
    srv_msg.response_check_option_content(step, 'Response', '3', None, 'T1', '0')
    srv_msg.response_check_option_content(step, 'Response', '3', None, 'T2', '0')
    srv_msg.response_check_option_content(step, 'Response', '3', None, 'sub-option', '13')
