...
@v6 @host_reservation @kea_only
	...
	Reserve prefix 3000:0:4000::/34 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:01.
	Reserve prefix 3000:0:8000::/34 in subnet 0 for host uniquely identified by f6:f5:f4:f3:f2:01.
...
@v6 @host_reservation @kea_only
	...
	Server is configured with 3000::/30 subnet with 3000::1-3000::10 pool.
	Server is configured with 3000:: prefix in subnet 0 with 32 prefix length and 34 delegated prefix length.
	Reserve prefix 3000:0:8000::/34 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:01.
	...
	Response MUST include option 25.
	Response option 25 MUST contain sub-option 26.
	Response sub-option 26 from option 25 MUST NOT contain prefix 3000:0:8000::.
	Response MUST include option 3.
	Response option 3 MUST contain sub-option 5.
...
@v6 @host_reservation @kea_only
	...
	Test Setup:
	Server is configured with 3000::/30 subnet with 3000::1-3000::10 pool.
	Server is configured with 3000:: prefix in subnet 0 with 32 prefix length and 36 delegated prefix length.
	Reserve prefix 3000:0:8000::/34 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:01.
	Reconfigure DHCP server.
    ...
    Client sets prefix value to 3000:0:8000::.
...
@v6 @host_reservation @kea_only
	...
	Test Setup:
	Server is configured with 3000::/30 subnet with 3000::1-3000::2 pool.
	Server is configured with 3000:: prefix in subnet 0 with 32 prefix length and 35 delegated prefix length.
	Reserve prefix 3000:0:8000::/33 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:01.
	Reserve prefix 3000::/33 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:02.
	Reconfigure DHCP server.
	...
	Response MUST include option 25.
	Response option 25 MUST contain sub-option 26.
	Response sub-option 26 from option 25 MUST NOT contain prefix 3000::.
	Response sub-option 26 from option 25 MUST NOT contain prefix 3000:0:8000::.
...
@v6 @host_reservation @kea_only
	...
	Server MUST respond with REPLY message.
    Response MUST include option 3.
	Response option 3 MUST contain sub-option 4.
	Response MUST include option 25.
	Response option 25 MUST contain sub-option 26.
	Response sub-option 26 from option 25 MUST contain prefix 3000:0:8000::.
