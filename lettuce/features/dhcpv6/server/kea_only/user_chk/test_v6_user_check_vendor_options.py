...
def test_user_check_hook_vendor_options_all(step):
    ...
    srv_control.config_srv_subnet(step, '3000::/64', '3000::5-3000::20')
    srv_control.config_srv_another_subnet_no_interface(step, '1000:1::/64', '1000:1::5-1000:1::5')
    srv_control.add_hooks(step, '$(SOFTWARE_INSTALL_DIR)/lib/hooks/libdhcp_user_chk.so')
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'tftp-servers', '7000::1')
    srv_control.config_srv_opt_space(step, 'vendor-4491', 'config-file', 'bootfile.from.server')
    ...
    #
    misc.test_procedure(step)
    srv_msg.client_sets_value(step, 'Client', 'DUID', '00:03:00:01:22:02:03:04:05:06')
    srv_msg.client_sets_value(step, 'Client', 'enterprisenum', '4491')
    srv_msg.client_does_include(step, 'Client', None, 'vendor-class')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '32')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '33')
    ...
    #
    misc.test_procedure(step)
    srv_msg.client_sets_value(step, 'Client', 'DUID', '00:03:00:01:33:02:03:04:05:06')
    srv_msg.client_sets_value(step, 'Client', 'enterprisenum', '4491')
    srv_msg.client_does_include(step, 'Client', None, 'vendor-class')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '32')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '33')
    ...
    srv_msg.client_sets_value(step, 'Client', 'DUID', '00:03:00:01:44:02:03:04:05:06')
    srv_msg.client_sets_value(step, 'Client', 'enterprisenum', '4491')
    srv_msg.client_does_include(step, 'Client', None, 'vendor-class')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '32')
    srv_msg.add_vendor_suboption(step, 'Client', '1', '33')
