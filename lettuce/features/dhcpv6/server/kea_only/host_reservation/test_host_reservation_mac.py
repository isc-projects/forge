...
def test_v6_host_reservation_mac_requesting_reserved_address_inside_the_pool(step):
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mac_requesting_reserved_address_outside_the_pool(step):
    misc.test_setup(step)
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mac_requesting_reserved_prefix(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::10')
    srv_control.host_reservation_in_subnet(step,
                                           'prefix',
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mac_requesting_reserved_prefix_PD_not_requested(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::10')
    srv_control.host_reservation_in_subnet(step,
                                           'prefix',
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mac_requesting_reserved_prefix_outside(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::10')
    srv_control.host_reservation_in_subnet(step,
                                           'prefix',
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mac_requesting_reserved_prefix_inside_empty_pool(step):
    misc.test_setup(step)
