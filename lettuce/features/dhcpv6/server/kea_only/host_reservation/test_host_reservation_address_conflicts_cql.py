...
def test_v6_host_reservation_cql_duplicate_reservation_duid():
    ...
    srv_control.enable_db_backend_reservation('Cassandra')
...
def test_v6_host_reservation_cql_conflicts_two_entries_for_one_host_different_subnets():
    ...
    srv_control.new_db_backend_reservation('Cassandra', 'hw-address', 'f6:f5:f4:f3:f2:01')
    srv_control.update_db_backend_reservation('dhcp6_subnet_id', '2', 'Cassandra', '2')
    srv_control.ipv6_address_db_backend_reservation('3000::3', '$(EMPTY)', 'Cassandra', '2')
    ...
    srv_msg.send_wait_for_message('MUST', None, 'REPLY')
    srv_msg.response_check_option_content('Response', '3', None, 'sub-option', '5')
    srv_msg.response_check_suboption_content('Response', '5', '3', 'NOT ', 'address', '3000::3')
...
def test_v6_host_reservation_cql_conflicts_reconfigure_server_with_reservation_of_used_address():
    ...
    srv_control.config_srv_subnet('3000::/30', '3000::1-3000::10')
    srv_control.enable_db_backend_reservation('Cassandra')
    srv_control.new_db_backend_reservation('Cassandra',
                                           'hw-address',
