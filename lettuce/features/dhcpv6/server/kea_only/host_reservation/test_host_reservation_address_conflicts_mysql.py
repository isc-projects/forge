...
def test_v6_host_reservation_mysql_duplicate_reservation_duid(step):
    ...
    srv_control.ipv6_address_db_backend_reservation(step, '3000::1', '$(EMPTY)', 'MySQL', '1')

    srv_control.new_db_backend_reservation(step, 'MySQL', 'duid', '00:03:00:01:f6:f5:f4:f3:f2:01')
    srv_control.update_db_backend_reservation(step, 'dhcp6_subnet_id', '1', 'MySQL', '2')
    srv_control.ipv6_address_db_backend_reservation(step, '3000::2', '$(EMPTY)', 'MySQL', '2')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_duplicate_reservation_address(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/30', '3000::1-3000::10')
    ...
    srv_control.new_db_backend_reservation(step, 'MySQL', 'duid', '00:03:00:01:f6:f5:f4:f3:f2:11')
    srv_control.update_db_backend_reservation(step, 'dhcp6_subnet_id', '1', 'MySQL', '1')
    srv_control.ipv6_address_db_backend_reservation(step, '3000::1', '$(EMPTY)', 'MySQL', '1')
    srv_control.upload_db_reservation(step, 'MySQL')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_conflicts_two_entries_for_one_host_different_subnets(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/30', '3000::1-3000::10')
    srv_control.enable_db_backend_reservation(step, 'MySQL')
    ...
    srv_control.update_db_backend_reservation(step, 'dhcp6_subnet_id', '2', 'MySQL', '2')
    srv_control.ipv6_address_db_backend_reservation(step, '3000::3', '$(EMPTY)', 'MySQL', '2')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_conflicts_reconfigure_server_with_reservation_of_used_address(step):
    misc.test_setup(step)
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_conflicts_reconfigure_server_with_reservation_of_used_address_2(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/30', '3000::1-3000::2')
    srv_control.build_and_send_config_files(step, 'SSH', 'config-file')
    srv_control.start_srv(step, 'DHCP', 'started')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_conflicts_reconfigure_server_with_reservation_of_used_address_renew_before_expire(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/30', '3000::1-3000::2')
    ...
    srv_control.new_db_backend_reservation(step, 'MySQL', 'duid', '00:03:00:01:f6:f5:f4:f3:f2:01')
    srv_control.update_db_backend_reservation(step, 'dhcp6_subnet_id', '1', 'MySQL', '1')
    srv_control.ipv6_address_db_backend_reservation(step, '3000::2', '$(EMPTY)', 'MySQL', '1')
    srv_control.upload_db_reservation(step, 'MySQL')
...
@pytest.mark.host_reservation
@pytest.mark.kea_only
def test_v6_host_reservation_mysql_conflicts_reconfigure_server_with_reservation_of_used_address_renew_after_expire(step):
    misc.test_setup(step)
