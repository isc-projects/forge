...
@pytest.mark.pgsql
def test_v6_host_reservation_pgsql_all_values_mac(step):
    ...
    srv_control.ipv6_prefix_db_backend_reservation(step,
                                                   '3001::',
                                                   '40',
                                                   '$(EMPTY)',
                                                   'PostgreSQL',
...
@pytest.mark.kea_only
@pytest.mark.pgsql
def test_v6_host_reservation_pgsql_duid_ll_matching(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::ff')
    srv_control.enable_db_backend_reservation(step, 'PostgreSQL')
...
@pytest.mark.kea_only
@pytest.mark.pgsql
def test_v6_host_reservation_pgsql_hwaddrr_not_matching(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::ff')
    srv_control.enable_db_backend_reservation(step, 'PostgreSQL')
    srv_control.new_db_backend_reservation(step, 'PostgreSQL', 'hw-address', 'f6:f5:f4:f3:f2:01')
...
@pytest.mark.kea_only
@pytest.mark.pgsql
def test_v6_host_reservation_pgsql_hwaddrr_matching(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::ff')
    srv_control.enable_db_backend_reservation(step, 'PostgreSQL')
    srv_control.new_db_backend_reservation(step, 'PostgreSQL', 'hw-address', 'f6:f5:f4:f3:f2:01')
...
@pytest.mark.kea_only
@pytest.mark.pgsql
def test_v6_host_reservation_pgsql_hwaddrr_matching_dual_backend(step):
    misc.test_setup(step)
    srv_control.config_srv_subnet(step, '3000::/64', '3000::1-3000::ff')
    srv_control.enable_db_backend_reservation(step, 'PostgreSQL')
    srv_control.new_db_backend_reservation(step, 'PostgreSQL', 'hw-address', 'f6:f5:f4:f3:f2:11')
    srv_control.update_db_backend_reservation(step, 'dhcp6_subnet_id', '1', 'PostgreSQL', '1')
    srv_control.ipv6_address_db_backend_reservation(step,
                                                    '3000::100',
                                                    '$(EMPTY)',
