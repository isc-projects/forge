...
Scenario: v6.legal.log.address-assigned-duid
...
@v6 @dhcp6 @kea_only @legal_logging
Scenario: v6.legal.log.address-renewed-duid
...
@v6 @dhcp6 @kea_only @legal_logging
Scenario: v6.legal.log.address-rebind-duid
...
@v6 @dhcp6 @kea_only @legal_logging
Scenario: v6.legal.log.address-assigned-docsis-modem
...
@v6 @dhcp6 @kea_only @legal_logging
Scenario: v6.legal.log.address-assigned-docsis-cmts
...
@v6 @dhcp6 @kea_only @legal_logging
Scenario: v6.legal.log.address-assigned-relay
