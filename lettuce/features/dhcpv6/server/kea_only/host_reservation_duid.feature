...
@v6 @host_reservation @kea_only
	...
	Test Setup:
	Server is configured with 3000::/64 subnet with 3000::1-3000::10 pool.
	Reserve prefix 3011::/90 in subnet 0 for host uniquely identified by 00:03:00:01:f6:f5:f4:f3:f2:01.
	DHCP server is started.
...
@v6 @host_reservation @kea_only
	...
	Response MUST include option 25.
	Response option 25 MUST contain sub-option 26.
	Response sub-option 26 from option 25 MUST NOT contain prefix 3000:0:4000.
	Response MUST include option 3.
    Response option 3 MUST contain sub-option 5.
