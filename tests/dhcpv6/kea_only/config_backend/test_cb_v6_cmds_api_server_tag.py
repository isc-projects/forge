...
def _subnet_set(server_tags, id, pool, subnet="2001:db8:1::/64"):
...
def _check_subnet_result(resp, server_tags, count=1, id=5, subnet="2001:db8:1::/64"):
...
def test_remote_subnet6_get_server_tags():
    _subnet_set(server_tags=["abc"], id=5, pool="2001:db8:1::1-2001:db8:1::10")
    _subnet_set(server_tags=["xzy"], id=6, pool="2001:db8:1::15-2001:db8:1::20")
    _subnet_set(server_tags=["all"], id=7, pool="2001:db8:2::15-2001:db8:2::20", subnet="2001:db8:2::/64")
...
def test_remote_subnet6_get_server_tags_all_incorrect_setup():
    ...
    _subnet_set(server_tags=["abc"], id=5, pool="2001:db8:1::1-2001:db8:1::10")
    _subnet_set(server_tags=["xyz"], id=5, pool="2001:db8:1::15-2001:db8:1::20")
...
def test_remote_subnet6_del_server_tags():
    ...
    _check_subnet_result(resp, server_tags=["all"], id=7, subnet="2001:db8:2::/64")
