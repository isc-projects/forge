...
INSERT INTO `dhcp4_server` VALUES (1,'all','special type: all servers','2021-02-17 13:08:42');
...
INSERT INTO `dhcp6_audit` VALUES (1,'dhcp6_server',2,0,1),(2,'dhcp6_subnet',2,0,2),(3,'dhcp6_shared_network',1,0,4),(4,'dhcp6_global_parameter',1,0,5),(5,'dhcp6_options',4,0,6),(6,'dhcp6_option_def',1,0,7);
...
INSERT INTO `dhcp6_audit_revision` VALUES (1,'2021-02-17 13:08:51','server set',1),(2,'2021-02-17 13:08:51','subnet set',2),(3,'2021-02-17 13:08:51','subnet specific option set',2),(4,'2021-02-17 13:08:51','shared network set',2),(5,'2021-02-17 13:08:51','global parameter set',2),(6,'2021-02-17 13:08:51','global option set',2),(7,'2021-02-17 13:08:51','option definition set',2);
...
INSERT INTO `dhcp6_global_parameter` VALUES (1,'decline-probation-period','123456','2021-02-17 13:08:51',0);
...
INSERT INTO `dhcp6_global_parameter_server` VALUES (1,2,'2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_option_def` VALUES (1,222,'foo','dhcp6',8,'2021-02-17 13:08:51',0,'',NULL,NULL);
...
INSERT INTO `dhcp6_option_def_server` VALUES (1,2,'2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_options` VALUES (1,7,NULL,'12','dhcp6',1,NULL,NULL,NULL,5,NULL,NULL,1,NULL,'2021-02-17 13:08:51'),(2,7,NULL,'123','dhcp6',1,NULL,2,NULL,1,NULL,NULL,NULL,NULL,'2021-02-17 13:08:51'),(3,7,NULL,'123','dhcp6',1,NULL,NULL,NULL,4,NULL,'net1',NULL,NULL,'2021-02-17 13:08:51'),(4,21,NULL,'isc.example.com','dhcp6',0,NULL,NULL,NULL,0,NULL,NULL,NULL,NULL,'2021-02-17 13:08:51'),(5,17,NULL,'4491','dhcp6',0,'',NULL,1,3,NULL,NULL,NULL,NULL,'2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_options_server` VALUES (1,2,'2021-02-17 13:08:51'),(2,2,'2021-02-17 13:08:51'),(3,2,'2021-02-17 13:08:51'),(4,2,'2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_pd_pool` VALUES (1,'2001:db8:2::',90,91,2,'2021-02-17 13:08:51',NULL,0,'','[  ]',NULL);
...
INSERT INTO `dhcp6_pool` VALUES (1,'2001:db8:1::10','2001:db8:1::10',2,'2021-02-17 13:08:51','','[  ]',NULL);
...
INSERT INTO `dhcp6_server` VALUES (1,'all','special type: all servers','2021-02-17 13:08:42'),(2,'abc','','2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_shared_network` VALUES (1,'net1','abc','!serverinterface!','2021-02-17 13:08:51',NULL,1,200,NULL,100,'[ \"XYZ\" ]',2,'{ \"some weird network\": 55 }',300,1,0.5,0.8,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `dhcp6_shared_network_server` VALUES (1,2,'2021-02-17 13:08:51');
...
INSERT INTO `dhcp6_subnet` VALUES (2,'2001:db8:1::/64',NULL,'!serverinterface!','2021-02-17 13:08:51',NULL,NULL,500,NULL,200,'[  ]',3,NULL,NULL,1000,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `dhcp6_subnet_server` VALUES (2,2,'2021-02-17 13:08:51');
...
INSERT INTO `hosts` VALUES (1,'	\n',1,NULL,2,NULL,'foo.example.com','','',0,'','',NULL,'');
...
INSERT INTO `ipv6_reservations` VALUES (1,'2001:db8:1::1',128,0,0,1),(2,'2001:db8:2:abcd::',64,2,0,1);
...
INSERT INTO `lease6` VALUES ('2001:db8:1::10','\0\0φυτσς',1000,'2021-02-17 13:25:31',2,3000,0,61439,128,0,0,'','φυτσς',1,2,0,NULL),('2001:db8:2::','\0\0φυτσς',1000,'2021-02-17 13:25:31',2,3000,2,24511,91,0,0,'','φυτσς',1,2,0,NULL);
...
INSERT INTO `lease6_stat` VALUES (2,0,0,1),(2,2,0,1);
...
-- Dump completed on 2021-02-17  5:08:51
