...
@v6 @host_reservation @kea_only
	...
	Reserve address 3000::10 in subnet 0 for host uniquely identified by duid 00:03:00:01:f6:f5:f4:f3:f2:01.
...
@v6 @host_reservation @kea_only
	...
	Reserve address 3000::ff in subnet 0 for host uniquely identified by duid 00:03:00:01:f6:f5:f4:f3:f2:01.
	Send server configuration using SSH and config-file.
DHCP server is started.
...
@v6 @host_reservation @kea_only
	...
	Test Setup:
	Server is configured with 3000::/64 subnet with 3000::1-3000::10 pool.
	Reserve prefix 3000::/90 in subnet 0 for host uniquely identified by duid 00:03:00:01:f6:f5:f4:f3:f2:01.
	Send server configuration using SSH and config-file.
DHCP server is started.
...
@v6 @host_reservation @kea_only
	...
	Test Setup:
	Server is configured with 3000::/64 subnet with 3000::1-3000::10 pool.
	Reserve prefix 2001:db8:1::/90 in subnet 0 for host uniquely identified by duid 00:03:00:01:f6:f5:f4:f3:f2:01.
	Send server configuration using SSH and config-file.
DHCP server is started.
