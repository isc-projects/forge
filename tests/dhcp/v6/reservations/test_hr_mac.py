...
@pytest.mark.v6
@pytest.mark.host_reservation
def test_v6_host_reservation_mac_requesting_reserved_prefix():
    misc.test_setup()
    srv_control.config_srv_subnet('3000::/64', '3000::1-3000::10')
...
@pytest.mark.v6
@pytest.mark.host_reservation
def test_v6_host_reservation_mac_requesting_reserved_prefix_PD_not_requested():
    misc.test_setup()
    srv_control.config_srv_subnet('3000::/64', '3000::1-3000::10')
    srv_control.host_reservation_in_subnet('prefix',
                                           '3000::/90',
...
def test_v6_host_reservation_mac_requesting_reserved_prefix_outside():
    ...
    srv_msg.response_check_include_option(25)
    srv_msg.response_check_option_content(25, 'sub-option', 26)
    srv_msg.response_check_suboption_content(26, 25, 'prefix', '3011::')
    srv_msg.response_check_include_option(3, expect_include=False)
