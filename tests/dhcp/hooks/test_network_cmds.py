...
def test_hook_v4_network_cmds_add_conflict():
    ...
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network4-list","arguments":{}}')
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network4-add","arguments":{"shared-networks": [{"match-client-id": true,"name": "name-xyz","option-data": [],"rebind-timer": 0,"relay": {"ip-addresses": ["0.0.0.0"]},"renew-timer": 0,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet4": [{"4o6-interface": "","4o6-interface-id": "","4o6-subnet": "","boot-file-name": "","id": 3,"match-client-id": true,"next-server": "0.0.0.0","option-data": [{"always-send": false,"code": 4,"csv-format": false,"data": "C7C7C764","name": "time-servers","space": "dhcp4"}],"pools": [{"option-data": [],"pool": "192.168.52.1/32"}],"rebind-timer": 2000,"relay": {"ip-addresses": ["192.168.50.249"]},"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"server-hostname": "","subnet": "192.168.52.0/24","valid-lifetime": 4000},{"4o6-interface": "","4o6-interface-id": "","4o6-subnet": "","boot-file-name": "","id": 4,"match-client-id": true,"next-server": "0.0.0.0","option-data": [{"always-send": false,"code": 4,"csv-format": false,"data": "C7C7C7C8","name": "time-servers","space": "dhcp4"}],"pools": [{"option-data": [],"pool": "192.168.53.1/32"}],"rebind-timer": 2000,"relay": {"ip-addresses": ["192.168.50.249"]},"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"server-hostname": "","subnet": "192.168.53.0/24","valid-lifetime": 4000}],"valid-lifetime": 0}]}}',
                                     exp_result=1)
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network4-get","arguments":{"name": "name-xyz"}}')
...
def test_hook_v6_network_cmds_add_on_interface_id():
    ...
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-add","arguments":{"shared-networks":[{"name": "name-abc","interface-id": "interface-abc","preferred-lifetime": 3000,"rebind-timer": 2000,"renew-timer": 1000,"valid-lifetime": 4000,"subnet6":[{"id":1,"pools": [{"pool": "2001:db8:1::1-2001:db8:1::10"}],"preferred-lifetime": 3000,"rebind-timer": 2000,"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet": "2001:db8:1::/64","valid-lifetime": 4000}]}]}}')
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-get","arguments":{"name": "name-abc"}}')
    srv_msg.forge_sleep(5, 'seconds')
...
def test_hook_v6_network_cmds_add_on_relay_addr():
    ...
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-add","arguments":{"shared-networks":[{"name": "name-abc", "relay":{"ip-addresses":["2001:db8::abcd"]},"preferred-lifetime": 3000,"rebind-timer": 2000,"renew-timer": 1000,"valid-lifetime": 4000,"subnet6":[{"id":1,"pools": [{"pool": "2001:db8:1::1-2001:db8:1::10"}],"preferred-lifetime": 3000,"rebind-timer": 2000,"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet": "2001:db8:1::/64", "valid-lifetime": 4000}]}]}}')
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-get","arguments":{"name": "name-abc"}}')
    srv_msg.forge_sleep(5, 'seconds')
...
def test_hook_v6_network_cmds_add_conflict():
    ...
    srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-list","arguments":{}}')
    response = srv_msg.send_ctrl_cmd_via_socket('{"command":"network6-add","arguments":{"shared-networks": [{"interface": "$(SERVER_IFACE)","name": "name-xyz","option-data": [],"preferred-lifetime": 0,"rapid-commit": false,"rebind-timer": 0,"relay": {"ip-addresses": ["::"]},"renew-timer": 0,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet6": [{"id": 3,"interface": "$(SERVER_IFACE)","option-data": [],"pd-pools": [],"pools": [{"option-data": [],"pool": "2001:db8:c::1/128"}],"preferred-lifetime": 3000,"rapid-commit": false,"rebind-timer": 2000,"relay": {"ip-addresses": ["::"]},"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet": "2001:db8:c::/64","valid-lifetime": 4000},{"id": 4,"interface": "$(SERVER_IFACE)","option-data": [],"pd-pools": [],"pools": [{"option-data": [],"pool": "2001:db8:d::1/128"}],"preferred-lifetime": 3000,"rapid-commit": false,"rebind-timer": 2000,"relay": {"ip-addresses": ["::"]},"renew-timer": 1000,"reservations-global": false,"reservations-in-subnet": true,"reservations-out-of-pool": false,"subnet": "2001:db8:d::/64","valid-lifetime": 4000}],"valid-lifetime": 0}]}}',
                                                exp_result=1)
