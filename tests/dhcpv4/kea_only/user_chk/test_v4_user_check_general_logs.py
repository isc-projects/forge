...
def test_user_check_IA_NA_no_registry_logging():
    ...
    # File stored in $(SOFTWARE_INSTALL_DIR)/var/log/kea.log MUST NOT contain line or phrase: DEBUG \[kea-dhcp4.hooks
    # File stored in $(SOFTWARE_INSTALL_DIR)/var/log/kea.log MUST contain line or phrase: ERROR \[kea-dhcp4.hooks
    # File stored in $(SOFTWARE_INSTALL_DIR)/var/log/kea.log MUST NOT contain line or phrase: DEBUG \[kea-dhcp4.callouts
...
def test_user_check_IA_NA_with_registry_unknown_user_logging_2():
    ...
    srv_msg.copy_remote('/tmp/user_chk_outcome.txt')
    srv_msg.compare_file('tests/dhcpv4/kea_only/user_chk/outcome_1.txt')
    # File stored in $(SOFTWARE_INSTALL_DIR)/var/log/kea.log MUST contain line or phrase: INFO  \[kea-dhcp4.hooks
    # File stored in $(SOFTWARE_INSTALL_DIR)/var/log/kea.log MUST contain line or phrase: DEBUG \[kea-dhcp4.callouts
