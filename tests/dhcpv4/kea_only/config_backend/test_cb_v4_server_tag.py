...
def test_server_tag_subnet():
    ...
    cfg_xys.add_subnet(check_on_reload=False,
                       server_tags=["abc"], subnet="192.168.50.0/24", id=1,
                       pools=[{'pool': "192.168.50.1-192.168.50.1"}])

    get_rejected()

    cfg_xys.add_subnet(check_on_reload=False,
                       server_tags=["unassigned"], subnet="192.168.50.0/24", id=3,
    ...
    cfg_xys.add_subnet(check_on_reload=False,
                       server_tags=["xys"], subnet="192.168.50.0/24", id=2,
    ...
    cfg_qwe.add_subnet(check_on_reload=False,
                       server_tags=["all"], subnet="192.168.50.0/24", id=2,
...
def test_server_tag_global_option():
    ...
    cfg.add_option(check_on_reload=False,
                   server_tags=["all"], code=10, csv_format=True, data="1.1.1.1", name="impress-servers", space="dhcp4")
    get_address(req_opts=[10], exp_option={"code": 10, "data": "1.1.1.1"})

    cfg.add_option(check_on_reload=False,
                   server_tags=["abc"], code=10, csv_format=True, data="2.2.2.2", name="impress-servers", space="dhcp4")
    get_address(req_opts=[10], exp_option={"code": 10, "data": "2.2.2.2"})

    cfg.add_option(check_on_reload=False,
                   server_tags=["xyz"], code=10, csv_format=True, data="3.3.3.3", name="impress-servers", space="dhcp4")
    get_address(req_opts=[10], exp_option={"code": 10, "data": "2.2.2.2"})
    ...
    cfg_xyz.del_option(check_on_reload=False, server_tags=["xyz"], code=10)
    get_address(req_opts=[10], exp_option={"code": 10, "data": "1.1.1.1"})
...
def test_server_tag_global_parameter():
    ...
    cfg.set_global_parameter(check_on_reload=False, server_tags=["unassigned"], boot_file_name="/dev/null_un")
    get_address(no_exp_boot_file_name="/dev/null_un")
    cfg.set_global_parameter(check_on_reload=False, server_tags=["xyz"], boot_file_name="/dev/null_xyz")
    cfg.set_global_parameter(check_on_reload=False, server_tags=["all"], boot_file_name="/dev/null_all")
