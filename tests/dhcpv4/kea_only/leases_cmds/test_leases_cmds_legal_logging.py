...
def test_hook_v4_lease_cmds_legal_logging_add():
    ...
    srv_msg.file_contains_line('$(SOFTWARE_INSTALL_DIR)/etc/kea/kea-leases4.csv',
                               None,
                               'aa:bb:cc:dd:11:22')
    srv_msg.file_contains_line('$(SOFTWARE_INSTALL_DIR)/etc/kea/kea-leases4.csv', None, '7777')
    srv_msg.file_contains_line('$(SOFTWARE_INSTALL_DIR)/etc/kea/kea-leases4.csv',
                               None,
                               '123456789')
    srv_msg.file_contains_line('$(SOFTWARE_INSTALL_DIR)/etc/kea/kea-leases4.csv',
...
def test_hook_v4_lease_cmds_legal_logging_wipe():
    ...
    srv_msg.copy_remote('$(SOFTWARE_INSTALL_DIR)/etc/kea/kea-legal*.txt')
    srv_msg.test_fail()
    # File stored in $(SOFTWARE_INSTALL_DIR)/etc/kea/kea-legal*.txt MUST contain line or phrase:
