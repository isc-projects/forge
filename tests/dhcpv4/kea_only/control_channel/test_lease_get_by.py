...
def test_control_channel_lease4_get_by():
    ...
    srv_control.add_ddns_server('127.0.0.1', 53000)
    ...
    # let's get 08 for in a different ways
    ...
    by_host_2 = _send_cmd("lease4-get-by-hostname", extra_param={"hostname": "xyz.com."})
    by_hw_2 = _send_cmd("lease4-get-by-hw-address", extra_param={"hw-address": "09:09:09:09:09:09"})