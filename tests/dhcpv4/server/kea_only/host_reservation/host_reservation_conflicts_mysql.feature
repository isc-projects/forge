...
@v4 @host_reservation @kea_only @trzz
...
@v4 @host_reservation @kea_only @trzz
Scenario: v4.host.reservation.conflicts.mysql.reconfigure-server-with-reservation-of-used-address
...
Create new MySQL reservation identified by hw-address ff:01:02:03:ff:77.
Add hostname reserved-hostname to MySQL reservation record id 1.
Add ipv4_address 192.168.50.2 to MySQL reservation record id 1.
...
@v4 @host_reservation @kea_only @trzz
Scenario: v4.host.reservation.conflicts.mysql.reconfigure-server-with-reservation-of-used-address-2

Test Setup:
Server is configured with 192.168.50.0/24 subnet with 192.168.50.1-192.168.50.2 pool.

Create new MySQL reservation identified by hw-address ff:01:02:03:ff:11.
Add hostname reserved-hostname to MySQL reservation record id 1.
Add ipv4_address 192.168.50.2 to MySQL reservation record id 1.
Add dhcp4_subnet_id 1 to MySQL reservation record id 1.
Upload hosts reservation to MySQL database.
