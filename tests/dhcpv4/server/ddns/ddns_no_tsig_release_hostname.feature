...
@v4 @ddns @notsig @forward_reverse_remove
    Scenario: ddns4.notsig-forw-and-rev-release-hostname
...
@v4 @ddns @notsig @forward_reverse_remove
    Scenario: ddns4.notsig-forw-and-rev-release-notenabled-hostname
...
@v4 @ddns @notsig @reverse_remove
    Scenario: ddns4.notsig-rev-release-hostname
...
@v4 @ddns @notsig @expire
    Scenario: ddns4.notsig-expire-hostname
