...
def test_dhcpd_feature_unicast_option_defined():
    ...
    add_line_in_global('option dhcp6.unicast $(SRV_IPV6_ADDR_GLOBAL);')
    add_line_in_global('authoritative;')
    add_line_in_global('subnet6 2001:db8::/32 {')
    add_line_in_global(' pool6 {')
    add_line_in_global('  range6 2001:db8:1:: 2001:db8:1::1;')
    add_line_in_global(' }')
...
def test_dhcpd_feature_unicast_option_defined_IA_PD():
    ...
    add_line_in_global('ddns-updates off;')
    add_line_in_global('authoritative;')
    add_line_in_global('subnet6 2001:db8:1::/64 {')
    add_line_in_global('  option dhcp6.unicast $(SRV_IPV6_ADDR_GLOBAL);')
    add_line_in_global('  pool6 {')
    add_line_in_global('    prefix6 2001:db8:1:0:0:100:: 2001:db8:1:0:0:0200:: /80;')
    add_line_in_global('  }')
    srv_control.build_and_send_config_files()
    srv_control.start_srv('DHCP', 'started')
...
def test_dhcpd_feature_unicast_option_defined_IA_TA():
    ...
    add_line_in_global('  option dhcp6.unicast $(SRV_IPV6_ADDR_GLOBAL);')
    add_line_in_global('  pool6 {')
    add_line_in_global('      range6 2001:db8:1:: temporary;')
    add_line_in_global('  }')
    srv_control.build_and_send_config_files()
    srv_control.start_srv('DHCP', 'started')
